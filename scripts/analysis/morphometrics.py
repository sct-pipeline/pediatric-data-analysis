...
def compute_interpolated_morphometrics(data_path, output_csv_path, output_csv_filename, level_type, t2w_pmj_label, t2w_seg_file, participants_info, final_csv_filename, subject):
    """
...
def main(subject, data_path, path_output, subject_dir, file_t2):
    ...
    final_csv_filename_vertlevels = output_csv_filename.replace('.csv', 'vert_levels_final.csv')
    final_csv_filename_spinallevels = output_csv_filename.replace('.csv', 'spinal_levels_final.csv')
    ...
    compute_morphometrics(
        ...
        output_csv_filename=os.path.join(output_csv_dir, f"{subject}_spinal_level_morphometrics.csv"),
        participants_info=participants_info,
        t2w_seg_file=t2w_seg_file,
    ...
    compute_interpolated_morphometrics(data_path, 
                                       path_output,
                                       output_csv_filename=os.path.join(output_csv_dir, f"{subject}_spinallevel_morphometrics.csv"), 
                                       level_type='SpinalLevel', 
                                       t2w_pmj_label=t2w_pmj_label, 
                                       t2w_seg_file=t2w_seg_file, 
                                       participants_info=participants_info, 
